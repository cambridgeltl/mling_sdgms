...
class FullTokenizer(object):
  ...
  def __init__(self, vocab_file, do_lower_case=True,
    ...
    elif self.piece == 'word': #  WordPiece
      self.wordpiece_tokenizer = WordpieceTokenizer(vocab=self.vocab)
    elif self.piece == 'word_model':
      self.wordlevel_tokenizer = WordlevelTokenizer(vocab=self.vocab)
  ...
  def tokenize(self, text):
    ...
    elif self.piece == 'word':
      for token in self.basic_tokenizer.tokenize(text):
        for sub_token in self.wordpiece_tokenizer.tokenize(token):
          split_tokens.append(sub_token)
    elif self.piece == 'word_model':
      for token in self.basic_tokenizer.tokenize(text):
        split_tokens.append(self.wordlevel_tokenizer.tokenize(token))
    return split_tokens
...
class WordlevelTokenizer(object):
  ...
  def tokenize(self, text):
    """Tokenizes a piece of text into words.
